...
internal static class Extension
{
    ...
    public static PaletteDark? DeepClone(this PaletteDark source)
    {
        return DeepClonePalette(source);
    }

    public static PaletteLight? DeepClone(this PaletteLight source)
    {
        return DeepClonePalette(source);
    }
